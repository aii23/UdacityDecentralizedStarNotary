...
contract StarNotary is ERC721 {
    ...
    constructor() ERC721("Decentralized Star Notary", "DSN") public { }
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == ownerOfToken1 || msg.sender == ownerOfToken2, "You must own at least one of two stars ");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == ownerOf(_tokenId), "You must own star to send it");
